...
typedef struct
{
	...
	uint8_t timeout;				/**< Zeit für diese Frage in Sekunden */
	uint8_t correct;				/**< Bitmaske für richtige Antworten */
} Question;
...
typedef struct
{
	char question[QUESTION_SIZE];			/**< Text der Fragestellung */
	char answers[NUM_ANSWERS][ANSWER_SIZE];		/**< Antworten */
	uint8_t timeout;				/**< Zeit für diese Frage in Sekunden (zu Informationszwecken mitgesendet) */
} QuestionMessage;
